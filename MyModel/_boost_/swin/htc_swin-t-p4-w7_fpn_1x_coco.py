...
data = dict(
    ...
    train=dict(
        ...
        ann_file='/opt/ml/detection/dataset/fold_1_train.json',
    ...
    val=dict(
        ...
        classes=('General trash', 'Paper', 'Paper pack', 'Metal', 'Glass',
                 'Plastic', 'Styrofoam', 'Plastic bag', 'Battery', 'Clothing'),
        ann_file='/opt/ml/detection/dataset/fold_1_val.json',
        img_prefix='/opt/ml/detection/dataset/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='detection',
                entity='yolo12',
                name='jina_fold1_htc_swin-large_fpn_2x',
                config=dict(
                    model=dict(
                        type='HybridTaskCascade',
                        backbone=dict(
                    ...
                    data=dict(
                        ...
                        train=dict(
                            ...
                            ann_file=
                            '/opt/ml/detection/dataset/fold_0_train.json',
                            img_prefix='/opt/ml/detection/dataset/',
                            pipeline=[
                                dict(type='LoadImageFromFile'),
                                dict(type='LoadAnnotations', with_bbox=True),
                        ...
                        val=dict(
                            ...
                            classes=('General trash', 'Paper', 'Paper pack',
                                     ...
                                     'Plastic bag', 'Battery', 'Clothing'),
                            ann_file=
                            '/opt/ml/detection/dataset/fold_0_val.json',
                            img_prefix='/opt/ml/detection/dataset/',
                            pipeline=[
                                dict(type='LoadImageFromFile'),
                                dict(
...
work_dir = './work_dirs/htc_swin-large_fpn_2x_coco_custom_aug'
auto_resume = False
gpu_ids = [0]
