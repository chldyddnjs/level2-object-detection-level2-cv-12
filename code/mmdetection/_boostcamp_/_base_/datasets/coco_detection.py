...
albu_train_transforms = [
    ...
    dict(type='HueSaturationValue', hue_shift_limit=23, sat_shift_limit=30, val_shift_limit=25, p=0.4),
...
data = dict(
    ...
    train=dict(
        ...
        ann_file=data_root + 'fold_2_train.json',
    ...
    val=dict(
        ...
        classes = ("General trash", "Paper", "Paper pack", "Metal", "Glass", 
           "Plastic", "Styrofoam", "Plastic bag", "Battery", "Clothing"),
        ann_file=data_root + 'fold_2_val.json',
        img_prefix=data_root,
